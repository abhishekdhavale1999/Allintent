...
upload_button = tk.Button(root, text="Upload Excel File", command=upload_file, bg='#4CAF50', fg='black', relief=tk.GROOVE)
...
about_button = tk.Button(root, text="About", command=about, bg='Red', fg='white', relief=tk.GROOVE)
